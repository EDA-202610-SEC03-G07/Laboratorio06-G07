...
def load_data(control):
    ...
    """
    books, authors, tags, book_tags, delta_time, delta_memory = logic.load_data(control)
    ...
    while working:
        ...
        if int(inputs[0]) == 1:
            ...
            print('Asociación de Géneros a Libros cargados: ' +
                  str(bktg))
            print(f"Tiempo de carga: {time:.2f} ms")
            print(f"Memoria utilizada para la carga: {memory:.2f} kB\n")
